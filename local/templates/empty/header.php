...
if(!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true)
	die();
$blsMainPage = $APPLICATION->GetCurPage(false) == SITE_DIR;//определяем главная ли у нас страница и определяем переменную
?>
<!DOCTYPE html>
                        ...
                        <div class="live-list-wrap">
                            <div class="live-list">
                                ...
                                <div class="live-list-item" id="live-2">
                                    <div class="live-item-body image">
                                        <a class="live-item-img" href=""><img src="" alt=""/></a>
                                        <div class="live-item-body-over">
                                            <div class="live-item-description">
